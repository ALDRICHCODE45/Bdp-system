...
export const EditEntradaSalidaForm = ({
  entradaSalida,
  onSuccess,
}: EditEntradaSalidaFormProps) => {
  const form = useUpdateEntradaSalidaForm(entradaSalida, onSuccess);

  return (
    <div className="p-4">
      <form
        id="edit-entrada-salida-form"
        autoComplete="off"
        onSubmit={(e) => {
          e.preventDefault();
          form.handleSubmit();
      ...
      >
        <input type="hidden" name="id" value={entradaSalida.id} />
        <FieldGroup>
