...
export const EditFacturaForm = ({
  ...
  const trasladados = useStore(
    form.store,
    (s) => s.values.totalImpuestosTransladados
  );
  const retenidos = useStore(
    form.store,
    (s) => s.values.totalImpuestosRetenidos
  );
  ...
  return (
    <div className="p-4">
      ...
      {isCapturador && !isEditable && (
        <div className="flex items-start gap-2 rounded-md border border-amber-200 bg-amber-50 px-4 py-3 text-amber-800 dark:border-amber-800 dark:bg-amber-950/30 dark:text-amber-300 mb-4">
                ...
                return (
                  <Field data-invalid={isInvalid} className="md:col-span-2">
                    ...
                    <Input
                      ...
                      spellCheck={false}
                    />
                    <FieldDescription>Fiscal CFDI</FieldDescription>
                    {isInvalid && <FieldError errors={field.state.meta.errors} />}
                  </Field>
                );
              }}
