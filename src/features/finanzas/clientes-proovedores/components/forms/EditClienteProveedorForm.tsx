...
export const EditClienteProveedorForm = ({
  clienteProveedor,
  onSuccess,
}: EditClienteProveedorFormProps) => {
  const form = useEditClienteProveedorForm(clienteProveedor, onSuccess);
  const { data: socios } = useSocios();

  return (
    <div className="p-4">
      <form
        id="edit-cliente-proveedor-form"
        autoComplete="off"
        onSubmit={(e) => {
          e.preventDefault();
          form.handleSubmit();
      ...
      <Field orientation="horizontal" className="mt-3">
        <Button
          type="submit"
          form="edit-cliente-proveedor-form"
          className="w-full"
        >
