...
export const createIngresoSchemaUI = z.object({
  ...
  fechaParticipacion: z.string().optional(),
  notas: z.string().optional(),
});

export type CreateIngresoFormValues = z.infer<typeof createIngresoSchemaUI>;
