...
import { useUpdateIngresoForm } from "../../hooks/useUpdateIngresoForm.hook";
...
export const EditIngresoForm = ({
  ingreso,
  onSuccess,
}: EditIngresoFormProps) => {
  const form = useUpdateIngresoForm(ingreso, onSuccess);
  ...
  return (
    <div className="p-4">
      ...
      <Field orientation="horizontal" className="mt-3">
        <Button type="submit" form="edit-ingreso-form" className="w-full">
          Actualizar Ingreso
        </Button>
      </Field>
    </div>
