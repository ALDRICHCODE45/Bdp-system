...
export function CreateEgresoSheet({ isOpen, onClose }: CreateEgresoSheetProps) {
    ...
    <Sheet open={isOpen} onOpenChange={onClose}>
      ...
      >
        ...
        <div className="px-6 pt-6 pb-4 border-b shrink-0">
          ...
          <SheetTitle className="text-lg font-semibold">Agregar egreso</SheetTitle>
          <p className="text-sm text-muted-foreground mt-1">
            Registrá un egreso del estado de cuenta.
          </p>
        </div>

        {/* Body */}
        <div className="flex-1 overflow-y-auto px-6 py-4">
          <MovimientoCreateForm tipo="EGRESO" onSuccess={onClose} />
        </div>
      </SheetContent>
    </Sheet>
  );
