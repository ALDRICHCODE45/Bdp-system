  ...
  const parsed = createColaboradorSchema.parse({
    ...
    estadoCivil:
      ...
      estadoCivil.trim() !== ""
        ...
        : null,
    tipoSangre:
      tipoSangre && typeof tipoSangre === "string" && tipoSangre.trim() !== ""
        ? tipoSangre
        : null,
    // Contacto y dirección
    direccion:
    ...
    ultimoGradoEstudios:
      ultimoGradoEstudios &&
      typeof ultimoGradoEstudios === "string" &&
      ultimoGradoEstudios.trim() !== ""
        ? ultimoGradoEstudios
        : null,
    escuela:
      escuela && typeof escuela === "string" && escuela.trim() !== ""
        ? escuela
        : null,
    ultimoTrabajo:
      ultimoTrabajo &&
      typeof ultimoTrabajo === "string" &&
      ultimoTrabajo.trim() !== ""
        ? ultimoTrabajo
        : null,
    // Referencias personales
    nombreReferenciaPersonal:
      nombreReferenciaPersonal &&
      typeof nombreReferenciaPersonal === "string" &&
      nombreReferenciaPersonal.trim() !== ""
        ? nombreReferenciaPersonal
        : null,
    telefonoReferenciaPersonal:
      telefonoReferenciaPersonal &&
      typeof telefonoReferenciaPersonal === "string" &&
      telefonoReferenciaPersonal.trim() !== ""
        ? telefonoReferenciaPersonal
        : null,
    parentescoReferenciaPersonal:
      parentescoReferenciaPersonal &&
      typeof parentescoReferenciaPersonal === "string" &&
      parentescoReferenciaPersonal.trim() !== ""
        ? parentescoReferenciaPersonal
        : null,
    // Referencias laborales
    nombreReferenciaLaboral:
      nombreReferenciaLaboral &&
      typeof nombreReferenciaLaboral === "string" &&
      nombreReferenciaLaboral.trim() !== ""
        ? nombreReferenciaLaboral
        : null,
    telefonoReferenciaLaboral:
      telefonoReferenciaLaboral &&
      typeof telefonoReferenciaLaboral === "string" &&
      telefonoReferenciaLaboral.trim() !== ""
        ? telefonoReferenciaLaboral
        : null,
    // Perfil extendido (rh-colaboradores-completo · P0)
    departamento:
      ...
      departamento.trim() !== ""
        ...
        : null,
    nivel:
      nivel && typeof nivel === "string" && nivel.trim() !== "" ? nivel : null,
    modalidad:
      modalidad && typeof modalidad === "string" && modalidad.trim() !== ""
        ? modalidad
        : null,
    tipoContrato:
      tipoContrato &&
    ...
    documentoIdentidad:
      documentoIdentidad &&
      typeof documentoIdentidad === "string" &&
      documentoIdentidad.trim() !== ""
        ? documentoIdentidad
        : null,
    emailPersonal:
      emailPersonal &&
      typeof emailPersonal === "string" &&
      emailPersonal.trim() !== ""
        ? emailPersonal
        : null,
