...
import { useEditColaboradorForm } from "../../hooks/useEditColaboradorForm.hook";
...
export const EditColaboradorForm = ({
  ...
  const form = useEditColaboradorForm(colaborador, onSuccess);
  ...
  return (
    <div className="p-4">
      ...
      >
        <FieldGroup>
          {/* Datos personales */}
          <FieldSeparator>Datos personales</FieldSeparator>
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <form.Field name="estadoCivil">
              {(field) => {
                ...
                return (
                  <Field data-invalid={isInvalid}>
                    <FieldLabel htmlFor={field.name}>Estado civil</FieldLabel>
                    <Input
                      id={field.name}
                      name={field.name}
                      value={field.state.value}
          ...
          {/* Contacto y socio */}
          <FieldSeparator>Contacto</FieldSeparator>
          <div className="grid gap-4 md:grid-cols-2">
                ...
                return (
                  <Field data-invalid={isInvalid}>
                    ...
                    <Input
                      ...
                      onChange={(e) => field.handleChange(e.target.value)}
                      aria-invalid={isInvalid}
                      placeholder="CURP del colaborador"
                    />
                    {isInvalid && (
                      <FieldError errors={field.state.meta.errors} />
                    )}
          ...
          <FieldSeparator>Condiciones laborales</FieldSeparator>
          <div className="grid gap-4 md:grid-cols-2">
          ...
          <FieldSeparator>Formación y experiencia</FieldSeparator>
          <div className="grid gap-4 md:grid-cols-2">
            <form.Field name="ultimoGradoEstudios">
              {(field) => {
                const isInvalid =
                  field.state.meta.isTouched && !field.state.meta.isValid;
                return (
                  <Field data-invalid={isInvalid}>
                    ...
                    <Input
                      ...
                      onChange={(e) => field.handleChange(e.target.value)}
                      aria-invalid={isInvalid}
                      placeholder="Licenciatura, Bachillerato, etc."
                    />
                    {isInvalid && (
                      <FieldError errors={field.state.meta.errors} />
                    )}
            ...
            <form.Field name="escuela">
              {(field) => {
                const isInvalid =
                  field.state.meta.isTouched && !field.state.meta.isValid;
                return (
                  <Field data-invalid={isInvalid}>
                    <FieldLabel htmlFor={field.name}>Escuela</FieldLabel>
                    <Input
                      id={field.name}
                      name={field.name}
                      value={field.state.value}
            ...
            <form.Field name="ultimoTrabajo">
              {(field) => {
                const isInvalid =
                  field.state.meta.isTouched && !field.state.meta.isValid;
                return (
                  <Field data-invalid={isInvalid} className="md:col-span-2">
                    <FieldLabel htmlFor={field.name}>Último trabajo</FieldLabel>
                    <Input
                      id={field.name}
                      name={field.name}
                      value={field.state.value}
                      ...
                      onChange={(e) => field.handleChange(e.target.value)}
                      aria-invalid={isInvalid}
                      placeholder="Empresa o puesto anterior"
                    />
                    {isInvalid && (
                      <FieldError errors={field.state.meta.errors} />
                    )}
          ...
          <FieldSeparator>Referencias personales</FieldSeparator>
          <div className="grid gap-4 md:grid-cols-2">
            <form.Field name="nombreReferenciaPersonal">
              {(field) => {
                const isInvalid =
                  field.state.meta.isTouched && !field.state.meta.isValid;
                return (
            ...
            <form.Field name="telefonoReferenciaPersonal">
              {(field) => {
                const isInvalid =
                  field.state.meta.isTouched && !field.state.meta.isValid;
                return (
            ...
            <form.Field name="parentescoReferenciaPersonal">
              {(field) => {
                const isInvalid =
                  field.state.meta.isTouched && !field.state.meta.isValid;
                return (
                  <Field data-invalid={isInvalid}>
                    <FieldLabel htmlFor={field.name}>
                      Parentesco referencia personal
                    </FieldLabel>
                    <Input
                      id={field.name}
                      name={field.name}
          ...
          <FieldSeparator>Referencias profesionales</FieldSeparator>
          <div className="grid gap-4 md:grid-cols-2">
            <form.Field name="nombreReferenciaLaboral">
              {(field) => {
                const isInvalid =
                  field.state.meta.isTouched && !field.state.meta.isValid;
                return (
            ...
            <form.Field name="telefonoReferenciaLaboral">
              {(field) => {
                const isInvalid =
                  field.state.meta.isTouched && !field.state.meta.isValid;
                return (
      ...
      <Field orientation="horizontal" className="mt-3">
        <Button type="submit" form="edit-colaborador-form" className="w-full">
