...
import { useSociosTableFilters } from "../hooks/useSociosTableFilters.hook";

interface SociosTableFiltersProps extends BaseFilterProps {
  table: Table<unknown>;
  onGlobalFilterChange?: (value: string) => void;
  onAdd?: () => void;
}

export const SociosTableFilters = ({
  table,
