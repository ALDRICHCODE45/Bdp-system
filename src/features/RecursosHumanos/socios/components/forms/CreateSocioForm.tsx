...
export const CreateSocioForm = ({ onSuccess }: CreateSocioFormProps) => {
  const form = useCreateSocioForm(onSuccess);

  return (
    <div className="p-4">
      <form
        id="create-socio-form"
        autoComplete="off"
        onSubmit={(e) => {
          e.preventDefault();
          form.handleSubmit();
      ...
      <Field orientation="horizontal" className="mt-3">
        <Button type="submit" form="create-socio-form" className="w-full">
          Crear Socio
        </Button>
      </Field>
    </div>
