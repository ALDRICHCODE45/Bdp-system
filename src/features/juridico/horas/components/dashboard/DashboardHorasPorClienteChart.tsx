...
const chartConfig = {
  horas: { label: "Horas", color: "var(--color-chart-4)" },
} satisfies ChartConfig;

export function DashboardHorasPorClienteChart({
  data,
  isLoading,
}: {
  data: Row[];
  ...
  return (
    <div className="rounded-xl border bg-card shadow-sm p-5">
      <div className="mb-4">
        <h3 className="text-sm font-semibold">Horas por Cliente</h3>
        <p className="text-xs text-muted-foreground mt-0.5">Top 10 clientes por horas registradas</p>
      </div>
