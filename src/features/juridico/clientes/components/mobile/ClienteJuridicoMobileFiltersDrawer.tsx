...
interface ClienteJuridicoMobileFiltersDrawerProps {
  open: boolean;
...
export function ClienteJuridicoMobileFiltersDrawer({
  open,
  onOpenChange,
  search,
  onSearchChange,
  onClearFilters,
}: ClienteJuridicoMobileFiltersDrawerProps) {
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-4 space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="Nombre, RFC, email, contacto..."
